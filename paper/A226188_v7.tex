...
\text{elapsed time} & 0.027685\ \text{s},\\
...
source, Makefile, manifest, and validation table.  The final public release
tag or archival DOI is the publication mechanism that will fix the source,
build recipe, and released data artifacts.
...
of the project package intended for the planned repository and archive listed
in the References; the public repository status and final DOI are finalization
items handled outside this draft.  The essential local artifacts are
...
from the project artifacts.  Numerical claims in the draft were
...
planned GitHub repository \url{https://github.com/carcorti/A226188} and planned
Zenodo archive.  The final DOI is to be inserted after archival deposit.
